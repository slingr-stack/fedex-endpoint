...
public class TrackReply  implements java.io.Serializable {
    ...
    private com.fedex.ws.track.v18.CompletedTrackDetail[] completedTrackDetails;
    ...
    public TrackReply(
           ...
           com.fedex.ws.track.v18.CompletedTrackDetail[] completedTrackDetails) {
     ...
     */
    public com.fedex.ws.track.v18.CompletedTrackDetail[] getCompletedTrackDetails() {
     ...
     */
    public void setCompletedTrackDetails(com.fedex.ws.track.v18.CompletedTrackDetail[] completedTrackDetails) {
        this.completedTrackDetails = completedTrackDetails;
    }

    public com.fedex.ws.track.v18.CompletedTrackDetail getCompletedTrackDetails(int i) {
        return this.completedTrackDetails[i];
    }

    public void setCompletedTrackDetails(int i, com.fedex.ws.track.v18.CompletedTrackDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "TrackReply"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "CompletedTrackDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "CompletedTrackDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
