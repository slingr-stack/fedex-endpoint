...
public class SendNotificationsReply  implements java.io.Serializable {
    ...
    private com.fedex.ws.track.v18.TrackNotificationPackage[] packages;
    ...
    public SendNotificationsReply(
           ...
           com.fedex.ws.track.v18.TrackNotificationPackage[] packages) {
     ...
     * to use on a subsequent request.
     */
    public com.fedex.ws.track.v18.TrackNotificationPackage[] getPackages() {
        return packages;
    }
     ...
     * to use on a subsequent request.
     */
    public void setPackages(com.fedex.ws.track.v18.TrackNotificationPackage[] packages) {
        this.packages = packages;
    }

    public com.fedex.ws.track.v18.TrackNotificationPackage getPackages(int i) {
        return this.packages[i];
    }

    public void setPackages(int i, com.fedex.ws.track.v18.TrackNotificationPackage _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "SendNotificationsReply"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "MoreDataAvailable"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "Packages"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "TrackNotificationPackage"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
