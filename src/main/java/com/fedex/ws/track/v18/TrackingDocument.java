...
public class TrackingDocument  implements java.io.Serializable {
    private com.fedex.ws.track.v18.TrackingDocumentType type;

    private com.fedex.ws.track.v18.Localization[] localizations;
    ...
    private com.fedex.ws.track.v18.DocumentPart[] parts;

    public TrackingDocument() {
    }

    public TrackingDocument(
           com.fedex.ws.track.v18.TrackingDocumentType type,
           com.fedex.ws.track.v18.Localization[] localizations,
           com.fedex.ws.track.v18.TrackingDocumentImageType imageType,
           org.apache.axis.types.NonNegativeInteger resolution,
           com.fedex.ws.track.v18.DocumentPart[] parts) {
           this.type = type;
     ...
     * @return type
     */
    public com.fedex.ws.track.v18.TrackingDocumentType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.fedex.ws.track.v18.TrackingDocumentType type) {
        this.type = type;
    }
     ...
     */
    public com.fedex.ws.track.v18.Localization[] getLocalizations() {
        return localizations;
    }
     ...
     * @param localizations
     */
    public void setLocalizations(com.fedex.ws.track.v18.Localization[] localizations) {
        this.localizations = localizations;
    }

    public com.fedex.ws.track.v18.Localization getLocalizations(int i) {
        return this.localizations[i];
    }

    public void setLocalizations(int i, com.fedex.ws.track.v18.Localization _value) {
     ...
     * @return parts
     */
    public com.fedex.ws.track.v18.DocumentPart[] getParts() {
        return parts;
    }
     ...
     * @param parts
     */
    public void setParts(com.fedex.ws.track.v18.DocumentPart[] parts) {
        this.parts = parts;
    }

    public com.fedex.ws.track.v18.DocumentPart getParts(int i) {
        return this.parts[i];
    }

    public void setParts(int i, com.fedex.ws.track.v18.DocumentPart _value) {
        this.parts[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "TrackingDocument"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "Localizations"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "Resolution"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "Parts"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "DocumentPart"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
