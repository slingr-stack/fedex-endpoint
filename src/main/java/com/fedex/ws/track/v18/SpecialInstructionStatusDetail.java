...
public class SpecialInstructionStatusDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.track.v18.SpecialInstructionsStatusCode status;
    ...
    public SpecialInstructionStatusDetail(
           com.fedex.ws.track.v18.SpecialInstructionsStatusCode status,
     ...
     */
    public com.fedex.ws.track.v18.SpecialInstructionsStatusCode getStatus() {
        return status;
    }
     ...
     */
    public void setStatus(com.fedex.ws.track.v18.SpecialInstructionsStatusCode status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "SpecialInstructionStatusDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("status");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "Status"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "SpecialInstructionsStatusCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("statusCreateTime");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "StatusCreateTime"));
