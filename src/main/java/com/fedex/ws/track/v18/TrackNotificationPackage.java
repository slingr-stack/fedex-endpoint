...
public class TrackNotificationPackage  implements java.io.Serializable {
    ...
    private com.fedex.ws.track.v18.TrackNotificationRecipientDetail[] recipientDetails;
    ...
    public TrackNotificationPackage(
           ...
           com.fedex.ws.track.v18.TrackNotificationRecipientDetail[] recipientDetails) {
     ...
     */
    public com.fedex.ws.track.v18.TrackNotificationRecipientDetail[] getRecipientDetails() {
     ...
     */
    public void setRecipientDetails(com.fedex.ws.track.v18.TrackNotificationRecipientDetail[] recipientDetails) {
        this.recipientDetails = recipientDetails;
    }

    public com.fedex.ws.track.v18.TrackNotificationRecipientDetail getRecipientDetails(int i) {
        return this.recipientDetails[i];
    }

    public void setRecipientDetails(int i, com.fedex.ws.track.v18.TrackNotificationRecipientDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "TrackNotificationPackage"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "TrackingNumberUniqueIdentifiers"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "ShipDate"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "RecipientDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "TrackNotificationRecipientDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
