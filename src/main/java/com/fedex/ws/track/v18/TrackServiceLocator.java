...
public class TrackServiceLocator extends org.apache.axis.client.Service implements com.fedex.ws.track.v18.TrackService {
    ...
    public com.fedex.ws.track.v18.TrackPortType getTrackServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.fedex.ws.track.v18.TrackPortType getTrackServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.fedex.ws.track.v18.TrackServiceSoapBindingStub _stub = new com.fedex.ws.track.v18.TrackServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.fedex.ws.track.v18.TrackPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.fedex.ws.track.v18.TrackServiceSoapBindingStub _stub = new com.fedex.ws.track.v18.TrackServiceSoapBindingStub(new java.net.URL(TrackServicePort_address), this);
                _stub.setPortName(getTrackServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "TrackService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "TrackServicePort"));
        }
