...
public class TrackSpecialInstruction  implements java.io.Serializable {
    ...
    private com.fedex.ws.track.v18.TrackDeliveryOptionType deliveryOption;

    /* Specifies the status and status update time of the track special
     * instructions. */
    private com.fedex.ws.track.v18.SpecialInstructionStatusDetail statusDetail;
    ...
    private com.fedex.ws.track.v18.AppointmentDetail requestedAppointmentTime;
    ...
    public TrackSpecialInstruction(
           ...
           com.fedex.ws.track.v18.TrackDeliveryOptionType deliveryOption,
           com.fedex.ws.track.v18.SpecialInstructionStatusDetail statusDetail,
           java.util.Calendar originalEstimatedDeliveryTimestamp,
           java.util.Calendar originalRequestTime,
           com.fedex.ws.track.v18.AppointmentDetail requestedAppointmentTime) {
     ...
     */
    public com.fedex.ws.track.v18.TrackDeliveryOptionType getDeliveryOption() {
        return deliveryOption;
    }
     ...
     */
    public void setDeliveryOption(com.fedex.ws.track.v18.TrackDeliveryOptionType deliveryOption) {
        this.deliveryOption = deliveryOption;
    }
     ...
     * instructions.
     */
    public com.fedex.ws.track.v18.SpecialInstructionStatusDetail getStatusDetail() {
        return statusDetail;
    }
     ...
     * instructions.
     */
    public void setStatusDetail(com.fedex.ws.track.v18.SpecialInstructionStatusDetail statusDetail) {
        this.statusDetail = statusDetail;
    }
     ...
     */
    public com.fedex.ws.track.v18.AppointmentDetail getRequestedAppointmentTime() {
     ...
     */
    public void setRequestedAppointmentTime(com.fedex.ws.track.v18.AppointmentDetail requestedAppointmentTime) {
        this.requestedAppointmentTime = requestedAppointmentTime;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "TrackSpecialInstruction"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "DeliveryOption"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "TrackDeliveryOptionType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "SpecialInstructionStatusDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("originalEstimatedDeliveryTimestamp");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "OriginalEstimatedDeliveryTimestamp"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "OriginalRequestTime"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "dateTime"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "RequestedAppointmentTime"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "AppointmentDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
