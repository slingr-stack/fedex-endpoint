...
public class AppointmentDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.track.v18.AppointmentTimeDetail[] windowDetails;
    ...
    public AppointmentDetail(
           java.util.Date date,
           com.fedex.ws.track.v18.AppointmentTimeDetail[] windowDetails) {
           this.date = date;
     ...
     */
    public com.fedex.ws.track.v18.AppointmentTimeDetail[] getWindowDetails() {
     ...
     */
    public void setWindowDetails(com.fedex.ws.track.v18.AppointmentTimeDetail[] windowDetails) {
        this.windowDetails = windowDetails;
    }

    public com.fedex.ws.track.v18.AppointmentTimeDetail getWindowDetails(int i) {
        return this.windowDetails[i];
    }

    public void setWindowDetails(int i, com.fedex.ws.track.v18.AppointmentTimeDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "AppointmentDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("date");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "Date"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "WindowDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v18", "AppointmentTimeDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
